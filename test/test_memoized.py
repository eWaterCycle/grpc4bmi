...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('get_grid_shape', [0, np.array([1])]),
        ('get_grid_x', [0, np.array([1])]),
        ('get_grid_y', [0, np.array([1])]),
        ('get_grid_z', [0, np.array([1])]),
        ('get_grid_spacing', [0, np.array([1])]),
        ('get_grid_origin', [0, np.array([1])]),
        ('get_grid_connectivity', [0, np.array([1])]),
        ('get_grid_offset', [0, np.array([1])]),
        ('get_grid_rank', [0]),
        ('get_grid_size', [0]),
        ('get_grid_type', [0]),
    ]
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('get_value', ['plate_surface__temperature', np.array([0, 0, 0])]),
